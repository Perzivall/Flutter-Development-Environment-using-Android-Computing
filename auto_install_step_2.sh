...
##Android-arm-release
cd /home/$YOUR_USER/android-sdk/flutter/bin/cache/artifacts/engine/android-arm-release/
cp linux-x64/ linux-arm64/ -fr
cd linux-arm64
mv gen_snapshot gen_snapshot_
echo '#!/bin/bash
...
cd /home/$YOUR_USER/android-sdk/flutter/bin/cache/artifacts/engine/android-arm64-profile/
cp linux-x64/ linux-arm64/ -fr
cd linux-arm64
mv gen_snapshot gen_snapshot_
echo '#!/bin/bash
...
##Android-arm-profile
cd /home/$YOUR_USER/android-sdk/flutter/bin/cache/artifacts/engine/android-arm-profile/
cp linux-x64/ linux-arm64/ -fr
cd linux-arm64
mv gen_snapshot gen_snapshot_
echo '#!/bin/bash
...
##Android-x64-release
cd /home/$YOUR_USER/android-sdk/flutter/bin/cache/artifacts/engine/android-x64-release/
cp linux-x64/ linux-arm64/ -fr
cd linux-arm64
mv gen_snapshot gen_snapshot_
echo '#!/bin/bash
...
cd /home/$YOUR_USER/android-sdk/flutter/bin/cache/artifacts/engine/android-x86-jit-release/
cp linux-x64/ linux-arm64/ -fr
cd linux-arm64
mv gen_snapshot gen_snapshot_
echo '#!/bin/bash
...
##Android-x64-profile
cd /home/$YOUR_USER/android-sdk/flutter/bin/cache/artifacts/engine/android-x64-profile/
cp linux-x64/ linux-arm64/ -fr
cd linux-arm64
mv gen_snapshot gen_snapshot_
echo '#!/bin/bash
