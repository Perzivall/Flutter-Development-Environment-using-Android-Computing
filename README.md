...
2. In Termux Command-Line, type
   ...
   ```
    curl -fsSl https://raw.githubusercontent.com/Perzivall/Flutter-Web-Development-Environment-using-Android/main/auto_install.sh | sh && proot-distro login debian -- sh -c "./auto_install_step_2.sh" && curl -fsSL https://raw.githubusercontent.com/Perzivall/Flutter-Web-Development-Environment-using-Android/main/auto_install_step_3.sh | sh
